...
var solveKepler = function(a, e, p, t, transform) {
...
var planet = function (params, transform) {
    ...
    this.returnTransform = function(v) {
        ...
        if ( this.cache[cacheIdx] ) {
            ...
            pos =  solveKepler(this.a, this.e,this.p, v, this.transform);
            this.cache[cacheIdx] =  {transform: "t" + pos.toString() + ',r0'};
            return this.cache[cacheIdx];
        }
    };
...
Raphael("holder", 800, 600, function () {
    ...
    r.planets.forEach(function(thisPlanet){
        ...
        thisPlanet.planet = new planet({a:thisPlanet.a, e:thisPlanet.e}, 
                                       {x:400, y:200, angle:0, scale: Math.sqrt(constants.orbitScale*zoomFac)});
    ...
    r.planets.forEach(function(thisPlanet){
         params = {};
         params[thisPlanet.name] = t0;
         thisPlanet.thing.attr(params);
         thisPlanet.text.attr(params);
    });
    ...
    function run() {
        ...
        r.planets.forEach(function(thisPlanet){
            ...
            params = {};
            param2 = {};
            params[thisPlanet.name] = t1;
            param2[thisPlanet.name] = t0;
            ...
            if (thisPlanet.name === 'Earth') {
                 ...
                 thisPlanet.thing.animate(params,1e3,function () {
                     if (thisPlanet.name === 'Earth'){
                         setTimeout(run);
                     }
                 });
                ...
                thisPlanet.thing.animate(params, 1e3);
            }
            thisPlanet.text.animate(params, 1e3);
        });
